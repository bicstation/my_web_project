<?php
// C:\project\my_web_project\app\public\duga_products_page.php
...
try {
    ...
    $executeParams = $params; // $paramsをコピー
    $executeParams[':limit'] = $itemsPerPage;
    $executeParams[':offset'] = $offset;

    if ($logger) {
        $logger->log("Executing Duga Product List SQL: " . $dataSql . " with params: " . json_encode($executeParams));
    }
    
    // bindParamを使う場合は個別に設定が必要
