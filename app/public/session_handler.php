...
class DBSessionHandler implements SessionHandlerInterface {
    private $db_conn; // データベース接続を保持するプロパティ
    ...
    public function read($sessionId) {
        ...
        if ($row) {
            ...
            error_log("DBSessionHandler::read - Raw data fetched: " . $row['data']);
    ...
    public function write($sessionId, $data) {
        ...
        error_log("DBSessionHandler::write - Raw data received: " . $data);
        // PHPのセッションモジュールが渡すデータは既にシリアライズされているので、ここではunserializeしない
